...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { fallidas: @factura.fallidas, fecha_desde: @factura.fecha_desde, fecha_hasta: @factura.fecha_hasta, id_cliente: @factura.id_cliente, validas: @factura.validas }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { fallidas: @factura.fallidas, fecha_desde: @factura.fecha_desde, fecha_hasta: @factura.fecha_hasta, id_cliente: @factura.id_cliente, validas: @factura.validas }
    assert_redirected_to factura_path(assigns(:factura))
  end
